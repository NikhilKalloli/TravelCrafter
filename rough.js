...
// if (!mapToken) {
//   console.log('Mapbox access token is missing. Set it using the environment variable MAP_TOKEN.');
...
// Assuming you have already declared and initialized your geocodingClient
...
const updateListings = async () => {
  ...
  sampleListings = await Promise.all(sampleListings.map(async (listing) => {
    ...
    // Add the geometry field to the listing
    return {
      ...listing,
      geometry: {
        type: 'Point',
  ...
  // Now, your sampleListings array has been updated with the geometry field
